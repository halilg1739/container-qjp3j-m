...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qjp3j-m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qjp3j-m.containers.anotherwebservice.com/
...
```
git clone git@github.com:halilg1739/container-qjp3j-m.git
cd container-qjp3j-m
```
...
```
docker attach container-qjp3j-m
```
